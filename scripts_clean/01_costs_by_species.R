...
db.over.time_damage <- db.over.time[which(db.over.time$Type_of_cost_merged=="Damage_costs"), ]
...
db.over.time_management <- db.over.time[which(db.over.time$Type_of_cost_merged=="Management_costs") ,]
# then we prepare a data.frame in which we will store our results
